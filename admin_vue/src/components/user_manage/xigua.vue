<template>
  <div class="g-container xg-user-manage">
    ...
    <el-table stripe :data="tableData" style="width: 100%" v-loading="listLoading" element-loading-text="给我一点时间">
        <el-table-column prop="userid" label="ID" resizable ></el-table-column>
        <el-table-column  label="注册手机号" resizable>
            <template slot-scope="scope">
              <span v-if="scope.row.mobilephone == ''">--</span>
        ...
        <el-table-column prop="is_weixin" label="绑定微信" width=""></el-table-column>
        <el-table-column prop="amount" label="余额" width=""></el-table-column>
        <el-table-column prop="mp_nums" label="添加公众号数" width=""></el-table-column>
  ...
  export default {
    ...
    methods: {
        getList() {
            ...
            // ajax
            this.$http.get('/Data/xg_members.html', {
